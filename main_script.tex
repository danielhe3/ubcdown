...
\textbf{A comprehensive analysis of the transcriptomic landscape of interstitial lung diseases}
...
Interstitial lung disease (ILD) is a group of debilitating disorders that cause patients to slowly lose their lung function, resulting in shortness of breath, limited capacity for movement, and early death. Over 4,000 British Columbians currently suffer from some form of ILD, yet not all of them receive proper therapy due to difficulties in identifying the precise ILD subtype. Unfortunately, diagnosing a specific ILD is difficult due to frequently nonspecific test results -- patients currently experience up to a 55\% rate of misdiagnosis. Even when patients are correctly diagnosed, some patients experience a rapid decline in lung function and little is known regarding the biological mechanisms behind this phenotype. To address the need for better ILD biomarkers, the goal of this thesis was to identify molecular markers in blood samples of ILD that are able to accurately identify specific subtypes and predict disease stability or progression.
...
\textbf{BALF} & bronchoalveolar lavage fluid\\
\addlinespace
...
\addlinespace
\textbf{DLCO\%} & diffusing capacity for carbon monoxide, percent predicted\\
...
\textbf{FVC\%} & forced vital capacity, percent predicted\\
...
\textbf{MHC} & major histocombatibility complex\\
...
\textbf{SLB} & surgical lung biopsy\\
...
Fibrotic ILD is a group of debilitating restrictive lung diseases that result from excess deposition of extracellular matrix (ECM) within the lung interstitium, resulting in decreased oxygen uptake and subsequent functional limitation. Although ILD can arise from a variety of causes (autoimmunity, environmental exposure), the most common subtype, IPF, is of unknown etiology. The incidence of IPF is 18.7 per 100,000 people in Canada, but increases to 39.5-156.4 per 100,000 people over the age of 60 -- a rate comparable to that of lung, breast, and prostate cancer (60.1, 129.9 and 120.8 per 100,000, respectively) {[}\citeproc{ref-hopkins_epidemiology_2016}{3},\citeproc{ref-canadian_cancer_statistics_advisory_committee_in_collaboration_with_the_canadian_cancer_society_statistics_canada_and_the_public_health_agency_of_canada_canadian_2023}{4}{]}. Patients with IPF have high morbidity, with quality of life scores in their first year of diagnosis comparable to those of patients with severe chronic obstructive pulmonary disease (COPD) {[}\citeproc{ref-hopkins_epidemiology_2016}{3}{]}. IPF patients are also at greater risk of comorbidities such as lung cancer, pulmonary hypertension, pulmonary embolisms {[}\citeproc{ref-raghu_comorbidities_2015}{5}{]}; acute exacerbations, which contribute significantly to the economic burden of the disease, can lead to respiratory failure and death {[}\citeproc{ref-morell_treatment_2016}{6},\citeproc{ref-hilberg_economic_2018}{7}{]}. Median survival for IPF is less than 5 years following diagnosis {[}\citeproc{ref-ley_clinical_2011}{8}{]}.

\subsection{Mechanisms of ILD}\label{mechanisms-of-ild}

A recurring hypothesis within the literature suggests that lung fibrosis is a result of repetitive injury to the alveoli, particularly type I alveolar epithelial cells (AT1s) which line the alveolar surface and are responsible for gas exchange. In the normal alveolus, type II alveolar epithelial cells (AT2s) secrete pulmonary surfactant to reduce surface tension within the alveoli, but AT2s undergo hyperplastic proliferation during stressful conditions such as injury. In addition to hyperplastic AT2s differentiating into AT1s via the transforming growth factor-beta (TGF-\(\beta\)) pathway, AT2s contribute to fibrosis via: 1) epithelial-mesenchymal transition (EMT) of AT2s to myofibroblasts; 2) apoptotic AT2s losing regulatory capacity over mesenchymal cells (fibroblasts), causing them to proliferate and produce more collagen; and 3) apoptotic AT2s releasing chemotactic factors to attract circulating fibrocytes, which invade the lung and expand the fibroblast pool {[}\citeproc{ref-bagnato_cellular_2015}{9}{]}.
...
Progressive pulmonary fibrosis (PPF) refers to a subset of non-IPF ILD subtypes that display a similar disease progression to IPF, which is defined over time by a decline in lung function, worsening respiratory symptoms, and increased fibrosis as seen on HRCT. Numerous criteria have been proposed to define PPF:
...
\item
  physiological progression (defined by absolute decline in forced vital capacity percent predicted {[}FVC\%{]} \underline{>}5\% and/or diffusing capacity of the lung for carbon monoxide percent predicted {[}D\textsubscript{LCO}\%{]} \underline{>}10\%);
\item
...
\setcounter{enumi}{2}
\item
  The unclassifiable ILD (uILD) trial {[}\citeproc{ref-maher_pirfenidone_2020}{20}{]} included patients on the basis of an absolute decline in FVC\% predicted of \underline{>}5\% or worsening respiratory symptoms within 6 months.
\item
  The RELIEF trial {[}\citeproc{ref-behr_pirfenidone_2021}{21}{]} included patients if they had an absolute annual decline in FVC\% predicted of \underline{>}5\% with at least three measurements within 6-24 months.
\end{enumerate}

Retrospective analysis of various cohorts evaluating the above criteria have revealed that few patients meet all of the above definitions but each of them are associated with a poor prognosis {[}\citeproc{ref-khor_patient_2023}{22}{]}. Depending on the definition used for PPF, \textasciitilde18-32\% of non-IPF ILDs display this phenotype compared to \textasciitilde60\% of IPF patients {[}\citeproc{ref-nasser_progressive_2021}{23}--\citeproc{ref-rajan_progressive_2023}{27}{]}; nevertheless, identification is important as patients with PPF were shown to have a reduced annual rate of decline in FVC\% predicted after receiving nintedanib compared to placebo {[}\citeproc{ref-flaherty_nintedanib_2019}{19}{]}.

\subsection{Objective}\label{objective}

Physiological (FVC\% predicted, D\textsubscript{LCO}\% predicted), histological (biopsy), cellular (bronchoalveolar lavage fluid, BALF), and radiological (HRCT) biomarkers are currently used to diagnose and assess lung function in the clinical management of ILDs (Figure \ref{fig:ildbiomarkersbefore}). However, up to 55\% of patients with ILD experience at least one misdiagnosis prior to MDD, and 43\% report a delay in diagnosis of at least one year {[}\citeproc{ref-cosgrove_barriers_2018}{28},\citeproc{ref-grewal_role_2019}{29}{]}. These delays are problematic for clinical management, particularly with respect to administering correct pharmacotherapy, and it is unsurprising that delays in diagnosing IPF are associated with an increased risk of mortality {[}\citeproc{ref-lamas_delayed_2011}{30}{]}.

Previous attempts to identify diagnostic molecular biomarkers of IPF have failed in part due to difficulties in reproducing reliable concentration cut-off thresholds to diagnose disease {[}\citeproc{ref-drakopanagiotakis_biomarkers_2018}{31}{]}. Promising IPF diagnostic biomarkers such as matrix metalloprotease-7 (MMP-7) are also elevated in the serum of patients with HP and other ILDs {[}\citeproc{ref-morais_serum_2015}{32}{]}, suggesting that candidate biomarkers are limited in their ability to discern disease subtype from the fibrotic process of ILD. Furthermore, patients with PPF have a poor prognosis and early adoption of anti-fibrotic therapy has been shown to be beneficial, but criteria for identifying PPF have not yet been agreed upon and guidelines are based on data obtained over the course of 1-2 years, after a substantial amount of irreversible progression has already occurred.

Given the inherent risks of lung biopsies in aging populations, the objective of this thesis was to investigate blood RNA for novel diagnostic and prognostic molecular biomarkers in patients with fibrotic ILD. I first performed a systematic review and meta-analysis of ILD transcriptomics (gene expression studies) to define currently understood molecular markers of ILD. Then, I examined the feasibility of using whole blood samples from ILD patients in a pilot study using a targeted gene assay, followed by a larger study examining whole blood ILD samples using bulk RNA-sequencing (RNA-seq). Finally, I investigated blood gene expression profiles at the cellular level using single cell RNA-sequencing (scRNA-seq).



\begin{figure}
\includegraphics[width=1\linewidth,]{./Images/ILD Biomarkers Before} \caption[Summary of ILD biomarkers (before)]{\textbf{Summary of current and proposed ILD biomarkers prior to thesis work.} Bullet points in black are recommended by diagnostic guidelines, while those in grey have been examined and validated but are not yet recommended as part of standard care. \textit{Abbreviations: bronchoalveolar lavage fluid, BALF; diffusing capacity of the lung for carbon monoxide percent predicted, D\textsubscript{LCO}\%; forced vital capacity percent predicted, FVC\%; hypersensitivity pneumonitis, HP; high-resolution computed tomography, HRCT; idiopathic pulmonary fibrosis, IPF; nonspecific interstitial pneumonia, NSIP; peripheral blood mononuclear cell, PBMC; rheumatoid arthritis-associated interstitial lung disease, RA-ILD; systemic sclerosis-associated interstitial lung disease, SSc-ILD; usual interstitial pneumonia, UIP.}}\label{fig:ildbiomarkersbefore}
\end{figure}
...
Transcriptomics datasets were concatenated and genes containing NA values were removed. ComBat (`sva' v3.46.0) was used to correct for study-specific batch effects, and biclusters of the batch-corrected matrix were identified using algorithms implemented in the `MoSBi' package (v1.4.0) {[}\citeproc{ref-rose_mosbi_2022}{52}{]}, as well as the unsupervised patient stratification (UnPaSt) algorithm, which is an unconstrained version of the Differentially ExpreSsed gene Modules iN Diseases (DESMOND) algorithm {[}\citeproc{ref-zolotareva_identification_2021}{53}{]}. Association between biclusters and clinical variables was assessed using a Chi-squared test (categorical; diagnostic class) or linear regression (continuous; FVC\%, D\textsubscript{LCO}\%).
...
I profiled the expression of 166 RNA transcripts in a cohort of patients with IPF, SSc-ILD, HP, or IPAF (Table \ref{tab:bloodpx}). The subtypes had similar race, FVC\%, D\textsubscript{LCO}\%, smoking status, and treatment status, but patients with SSc-ILD and IPAF were younger at time of sampling and patients with IPF were predominantly male which is in line with previously reported cohorts {[}\citeproc{ref-zaman_differences_2020}{105}{]}.
...
\begin{table}[!h]
\centering\centering
\caption[ILD blood pilot study cohort]{\label{tab:bloodpx}\textbf{Summary table of clinical demographics of patients probed for whole blood RNA expression.}}
\centering
...
D\textsubscript{LCO}\%, mean ± SD & 42.41 ± 11.79 & 54.70 ± 19.46 & 45.00 ± 13.21 & 52.00 ± 5.20 & \textit{p} = 0.0624\\
...
D\textsubscript{LCO}\% predicted & 26; 56.81 ± 17.41 & 13; 50.77 ± 12.42 & 6; 56.33 ± 11.20 & 5; 59.00 ± 21.69 & 3; 59.33 ± 2.31 & 13; 63.15 ± 17.40 & \textit{p} = 0.5555\\
\midrule
...
FVC Rel. Decl. \underline{<}10\% & 5 (14\%) & 12 (44\%) & 1 (14\%) & 4 (67\%) & 2 (50\%) & 3 (19\%) & \textit{p} = 0.0148\\
FVC Rel. Decl. \underline{<}5\% & 11 (31\%) & 17 (63\%) & 2 (29\%) & 4 (67\%) & 3 (75\%) & 5 (31\%) & \textit{p} = 0.0527\\
...
I first examined differences in the peripheral transcriptome of specific ILD subtypes against each other. After controlling for race as a confounding variable (Figure \ref{fig:rnaseqPCA}), IPF and SSc-ILD were the most transcriptionally distinct subtypes with 165 DEGs at an FDR\textless0.05, a majority of which were associated with inteferon (IFN) signaling (Figure \ref{fig:degild}A,C-D, Table \ref{tab:ipfvsssc}, Table \ref{tab:ipfsscpathway}). No DEGs were identified between IPF and HP (Figure \ref{fig:degild}B), but two DEGs at FDR\textless0.05 were identified between IPF and IPAF and 710 between SSc-ILD and IPAF, though these comparisons were limited by the small number of IPAF samples (n=4) (Table \ref{tab:ILDdeg}). I further investigated DEGs between radiological subtypes, and found that fibrotic HP patterns were distinct from NSIP patterns with 16 DEGs as FDR\textless0.05 (Figure \ref{fig:raddeg}); similar genes were up-regulated when compared to UIP, though these were not significant (Table \ref{tab:degrad}).
...
\begin{longtable}[t]{>{\raggedright\arraybackslash}p{1.0in}>{\raggedright\arraybackslash}p{1.0in}>{\centering\arraybackslash}p{0.6in}}
\caption[ILD survival model genes]{\label{tab:ildsurvivalgenes}\textbf{Genes in the Cox proportional hazards ILD survival model.} }\\
\toprule
Ensembl ID & Gene & Weight\\
\midrule
\endfirsthead
\caption[]{\label{tab:ildsurvivalgenes}\textbf{Genes in the Cox proportional hazards ILD survival model.}  \textit{(continued)}}\\
\toprule
Ensembl ID & Gene & Weight\\
\midrule
\endhead
...
{\centering \includegraphics[width=0.9\linewidth,]{./Figures/scRNAseq/SCAILD_forestplot} 

}

\caption[scRNA-seq cell abundance]{\textbf{Forest plot comparing abundance of cell clusters identified by scRNA-seq.} Significantly different cell clusters (shown in bold italics) were determined by a binomial generalized linear model and corrected using the Bonferroni method. Dot sizes are scaled to indicate standard error (SE), with smaller SE corresponding to larger dots.}\label{fig:forestplot}
\end{figure}
...
To investigate differentially expressed genes between IPF and HP within cell clusters, I used the MAST algorithm, which avoids pseudoreplication bias in single-cell studies as outlined in {[}\citeproc{ref-zimmerman_practical_2021}{166}{]} (Table \ref{tab:degscrnaseq}). Across multiple cell types, \textit{JUN} was highly expressed in samples from patients with HP (Figure \ref{fig:junumap}). In addition to being differentially abundant, NK cell subsets (NK CD56 bright, NK CD56 dim, natural killer T cells {[}NKT{]}) expressed increased \textit{MYOM2} in HP patients compared to IPF patients (Figure \ref{fig:scrnaseqnk}). Moreover, in NK CD56 dim and NKT cells, I observed a downregulation of \textit{KLRC1} in IPF compared to HP samples, which was in contrast to an increase in \textit{KLRC2} expression.



\begin{figure}

{\centering \includegraphics[width=0.9\linewidth,]{./Figures/scRNAseq/nk_ipfhp_v1} 

}

\caption[scRNA-seq NK DEGs]{\textbf{Differentially expressed genes between NK cell subsets of IPF and HP as shown by violin plots (A) and UMAP plots (B).} Significance, as determined by the MAST algorithm, is indicated by FDR\textless0.01 (***) and FDR\textless0.05 (**).}\label{fig:scrnaseqnk}
\end{figure}

I also identified a number of differentially expressed genes in monocytes. \textit{TMEM176B} and its paralog \textit{TMEM176A} were upregulated in IPF samples across classical, intermediate, and non-classical monocyte subsets (Figure \ref{fig:scrnaseqmono}). A similar upregulation in expression of \textit{HLA-DRB5} and \textit{HLA-DQA2} was observed in IPF monocytes, while classical and intermediate monocytes in HP were upregulated in \textit{CLEC4E} and \textit{FOLR3}.



\begin{figure}

{\centering \includegraphics[width=0.9\linewidth,]{./Figures/scRNAseq/monocyte_ipfhp_v1} 

}

\caption[scRNA-seq monocyte DEGs]{\textbf{Differentially expressed genes between monocytes subsets as shown by violin plots (A) and UMAP plots (B).} Significance, as determined by the MAST algorithm, is indicated by FDR\textless0.01 (***).}\label{fig:scrnaseqmono}
\end{figure}
...
\bibitem[\citeproctext]{ref-xu_single-cell_2016}
\CSLLeftMargin{151. }%
...
\bibitem[\citeproctext]{ref-habermann_single-cell_2020}
\CSLLeftMargin{152. }%
...
\bibitem[\citeproctext]{ref-aran_reference-based_2019}
\CSLLeftMargin{153. }%
...
\bibitem[\citeproctext]{ref-reyfman_single-cell_2019}
\CSLLeftMargin{154. }%
...
\bibitem[\citeproctext]{ref-misharin_monocyte-derived_2017}
\CSLLeftMargin{155. }%
...
\bibitem[\citeproctext]{ref-adams_single-cell_2020}
\CSLLeftMargin{156. }%
...
\bibitem[\citeproctext]{ref-cottin_presentation_2018}
\CSLLeftMargin{157. }%
...
\bibitem[\citeproctext]{ref-monaco_rna-seq_2019}
\CSLLeftMargin{158. }%
...
\bibitem[\citeproctext]{ref-finak_mast_2015}
\CSLLeftMargin{159. }%
...
\bibitem[\citeproctext]{ref-micevic_il-7r_2023}
\CSLLeftMargin{160. }%
...
\bibitem[\citeproctext]{ref-jin_cish_2023}
\CSLLeftMargin{161. }%
...
\bibitem[\citeproctext]{ref-toffali_isoform_2023}
\CSLLeftMargin{162. }%
...
\bibitem[\citeproctext]{ref-waldman_enavasp_2022}
\CSLLeftMargin{163. }%
...
\bibitem[\citeproctext]{ref-tippalagama_hla-dr_2021}
\CSLLeftMargin{164. }%
...
\bibitem[\citeproctext]{ref-xu_dynamic_2020}
\CSLLeftMargin{165. }%
...
\bibitem[\citeproctext]{ref-zimmerman_practical_2021}
\CSLLeftMargin{166. }%
...
\bibitem[\citeproctext]{ref-unterman_single-cell_2024}
\CSLLeftMargin{167. }%
...
\bibitem[\citeproctext]{ref-heukels_fibrocytes_2018}
\CSLLeftMargin{168. }%
...
\bibitem[\citeproctext]{ref-evren_distinct_2021}
\CSLLeftMargin{169. }%
...
\bibitem[\citeproctext]{ref-unterman_single-cell_2022}
\CSLLeftMargin{170. }%
...
\bibitem[\citeproctext]{ref-li_s100a12_2022}
\CSLLeftMargin{171. }%
...
\bibitem[\citeproctext]{ref-de_morree_dysferlin_2013}
\CSLLeftMargin{172. }%
...
\bibitem[\citeproctext]{ref-porrello_factor_2018}
\CSLLeftMargin{173. }%
...
\bibitem[\citeproctext]{ref-lurton_isolation_1999}
\CSLLeftMargin{174. }%
...
\bibitem[\citeproctext]{ref-etikala_lr8_2017}
\CSLLeftMargin{175. }%
...
\bibitem[\citeproctext]{ref-louvet_identification_2005}
\CSLLeftMargin{176. }%
...
\bibitem[\citeproctext]{ref-segovia_targeting_2019}
\CSLLeftMargin{177. }%
...
\bibitem[\citeproctext]{ref-lasithiotaki_nlrp3_2016}
\CSLLeftMargin{178. }%
...
\bibitem[\citeproctext]{ref-zhang_ezh2_2021}
\CSLLeftMargin{179. }%
...
\bibitem[\citeproctext]{ref-cai_single-cell_2020}
\CSLLeftMargin{180. }%
...
\bibitem[\citeproctext]{ref-braud_hla-e_1998}
\CSLLeftMargin{181. }%
...
\bibitem[\citeproctext]{ref-flerlage_single_2023}
\CSLLeftMargin{182. }%
...
Seven studies did not pass our quality control assessment. Two studies did not have adequate sample labels for diagnosis {[}\citeproc{ref-zhao_metabolic_2017}{183},\citeproc{ref-zhu_integration_2018}{184}{]}, one {[}\citeproc{ref-christmann_association_2014}{126}{]} was a duplicate of {[}\citeproc{ref-christmann_mir-155_2016}{81}{]}, one {[}\citeproc{ref-ghosh_lung_2022}{185}{]} was a suspected duplicate of another study {[}\citeproc{ref-borie_colocalization_2022}{69}{]} due to having similar sample numbers and both being from the LTRC, one focused only on familial pulmonary fibrosis {[}\citeproc{ref-el-chemaly_immunome_2018}{186}{]}, and two studies were omitted due to poor data quality {[}\citeproc{ref-jia_interleukin_2023}{57},\citeproc{ref-zhou_integrated_2019}{187}{]}.
...
\begin{longtable}[t]{>{\raggedright\arraybackslash}p{1.0in}>{\raggedright\arraybackslash}p{1.0in}>{\centering\arraybackslash}p{0.6in}}
\caption[ILD (excluding SSc-ILD) survival model genes]{\label{tab:notsscsurvivalgenes}\textbf{Genes in the Cox proportional hazards ILD survival model (excluding SSc-ILD).} }\\
\toprule
Ensembl ID & Gene & Weight\\
\midrule
\endfirsthead
\caption[]{\label{tab:notsscsurvivalgenes}\textbf{Genes in the Cox proportional hazards ILD survival model (excluding SSc-ILD).}  \textit{(continued)}}\\
\toprule
Ensembl ID & Gene & Weight\\
\midrule
\endhead
...
{\centering \includegraphics[width=1\linewidth,]{./Figures/scRNAseq/jun_umap_v1} 

}

\caption[JUN expression]{\textbf{Expression of JUN in scRNAseq.} UMAP plots cellular subsets coloured by JUN expression.}\label{fig:junumap}
\end{figure}
