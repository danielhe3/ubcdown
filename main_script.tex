...
\begin{figure}
\includegraphics[width=1\linewidth,]{./Figures/FigE10_Envisia} \caption[Bicluster similarity]{\textbf{Upset plots of gene signatures featured in IPF vs non-IPF ILD and HP vs non-HP ILD expanded classifiers.} Genes from the Envisia classifier published in Choi et al.~(2017) are included as a comparison.}\label{fig:envisia}
\end{figure}
