...
```{r prisma, eval = T, echo = F, out.width='0.9\\linewidth', fig.cap="(ref:prisma-cap)", fig.scap = "PRISMA diagram", out.extra='', fig.align='center'}
knitr::include_graphics("./Figures/SysReview/Figure1_Prisma.pdf")
```
...
kableExtra::kbl(
  readr::read_csv(here::here('Tables', 'SysReview', 'datasets.csv')),
  longtable = F,
  format = 'latex',
  booktabs = T, 
  linesep = "",
  ...
  caption.short = "List of lung transcriptomics studies") %>%
...
```{r mintmodel, eval = T, out.width='1\\linewidth',echo=FALSE, fig.cap="(ref:mintmodel-cap)", fig.scap = "ILD classification models", out.extra='', fig.align='center'}
knitr::include_graphics("./Figures/SysReview/Figure3_MINT.pdf")
```
...
(ref:ILDvILD-cap) \textbf{ILD subtype-specific classification models.} IPF-specific and HP-specific classification models were developed through MINT integration of lung transcriptomics datasets. MINT-PLS projection of samples for classification models of IPF vs non-IPF ILD (A) and HP vs non-HP ILD (C), with corresponding performance on held-out test datasets (B, D). Upregulated pathways using gene signatures identified in classification models for IPF against non-IPF ILD and HP against non-HP ILD are shown in (E).

```{r ILDvILD, eval = T, out.width='0.95\\linewidth',echo=FALSE, fig.cap="(ref:ILDvILD-cap)", fig.scap = "ILD vs ILD models", out.extra='', fig.align='center'}
knitr::include_graphics("./Figures/SysReview/Figure4_ILDvsILD.pdf")
```

\captionsetup{width=6.5in} <!-- makes table caption stays in margins -->

(ref:modelperf-cap) \textbf{Summary of ILD classification model performance on indicated test sets.} Area under receiver operating curve (AUC), balanced error rate (BER), sensitivity, and specificity were calculated using the ‘auroc.mint.splsda’ function from mixOmics. 95\% confidence intervals (95\% C.I.) were determined via bootstrapping.
...
kableExtra::kbl(
  ...
  caption.short = "ILD classification model performance") %>%
  kableExtra::kable_styling(full_width = TRUE) %>%  # table spans across left to right margins
  kableExtra::footnote(
...
```{r ILDpathways, eval = T, out.width='1\\linewidth',echo=FALSE, fig.cap="(ref:ILDpathways-cap)", fig.scap = "Pathways of ILD", out.extra='', fig.align='center'}
knitr::include_graphics("./Figures/SysReview/Figure5_pathways.pdf")
```
...
```{r biclust, eval = T, out.width='1\\linewidth',echo=FALSE, fig.cap="(ref:biclust-cap)", fig.scap = "ILD biclusters", out.extra='', fig.align='center'}
knitr::include_graphics("./Figures/SysReview/Figure6_biclusters.pdf")
```
