...
kableExtra::kbl(
  ...
  caption.short = "Up- and down-regulated SSc-ILD pathways compared to IPF") %>%
...
kableExtra::kbl(
  ...
  caption.short = "List of DEGs between radiological patterns (blood RNA-seq)") %>%
  column_spec(c(1), width="1.3in") %>%
  column_spec(c(2), width="1.2in") %>%
...
(ref:ppfdeg-cap) \textbf{Differentially expressed genes in PPF.} Volcano plots of (A) PPF, (B) relative decline in FVC% predicted of \underline{>}10\%, (C) radiological progression, and (D) relative decline in FVC% predicted of >5\% within 2 years. (E-G) Boxplots of significant DEGs associated with various PPF criteria. 

```{r ppfdeg, eval = T, out.width='0.80\\linewidth',echo=FALSE, fig.cap="(ref:ppfdeg-cap)", fig.scap = "DEGs associated with PPF", out.extra='', fig.align='center'}
knitr::include_graphics("./Figures/BloodRNAseq/ppf_deg_v1.pdf")
```

(ref:ppfdegipf-cap) \textbf{Differentially expressed genes in IPF patients that experience PPF.} (A) Volcano plot of DEGs between PPF and non-PPF patients in IPF, and (B) boxplots of THBS3-AS1 expression in ILD patients grouped by whether or not they experienced a relative decline in FVC\% predicted of \underline{>}10\% within 2 years. 

```{r ppfdegipf, eval = T, out.width='0.75\\linewidth',echo=FALSE, fig.cap="(ref:ppfdegipf-cap)", fig.scap = "DEGs associated with radiological progression", out.extra='', fig.align='center'}
...
kableExtra::kbl(
  ...
  caption.short = "List of DEGs between PPF and non-PPF (blood RNA-seq)") %>%
...
kableExtra::kbl(
  ...
  caption.short = "List of DEGs associated with radiological progression (blood RNA-seq)") %>%
  column_spec(c(1), width="1.0in") %>%
  column_spec(c(2), width="1.2in") %>%
  column_spec(c(3), width="0.8in") %>%
  column_spec(c(4), width="0.6in") %>%
...
(ref:ildsurvivalgenes-cap) \textbf{Genes included in the Cox proportional hazards ILD survival model.} 
...
(ref:notsscsurvivalgenes-cap) \textbf{Genes included in the Cox proportional hazards ILD survival model (excluding SSc-ILD).} 
...
kableExtra::kbl(
  ...
  caption.short = "ILD (excluding SSc-ILD) survival model genes") %>%
  column_spec(c(1), width="1.0in") %>%
...
```{r notsscsurvival, eval = T, out.width='0.84\\linewidth',echo=FALSE, fig.cap="(ref:notsscsurvival-cap)", fig.scap = "ILD (excluding SSc-ILD) survival model", out.extra='', fig.align='center'}
