...
```{r ppfdeg, eval = T, out.width='0.85\\linewidth',echo=FALSE, fig.cap="(ref:ppfdeg-cap)", fig.scap = "Correlation of PCs with metadata (blood RNA-seq)", out.extra='', fig.align='center'}
...
```{r ppfdegipf, eval = T, out.width='0.85\\linewidth',echo=FALSE, fig.cap="(ref:ppfdegipf-cap)", fig.scap = "Correlation of PCs with metadata (blood RNA-seq)", out.extra='', fig.align='center'}
...
```{r ppfdegtab, eval = T, echo = F, warning = FALSE, message=FALSE, out.extra='', fig.scap='DEGs: PPF', fig.align='center'}
...
```{r ppfradtab, eval = T, echo = F, warning = FALSE, message=FALSE, out.extra='', fig.scap='DEGs: Radiological Progression', fig.align='center'}
...
(ref:ildsurvivalgenes-cap) \textbf{ILD survival model genes.} Ensembl IDs, gene symbols (if available), and model weights are shown. 
...
(ref:notsscsurvivalgenes-cap) \textbf{ILD survival model genes.} Ensembl IDs, gene symbols (if available), and model weights are shown. 

```{r notsscsurvivalgenes, eval = T, echo = F, warning = FALSE, message=FALSE, out.extra='', fig.scap='ILD survival model genes', fig.align='center'}
