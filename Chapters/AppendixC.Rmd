...
```{r herazomaya, eval = T, out.width='0.82\\linewidth',echo=FALSE, fig.cap="(ref:herazomaya-cap)", fig.scap = "Comparison with 52-gene risk model", out.extra='', fig.align='center'}
