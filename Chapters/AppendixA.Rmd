...
```{r bloodmodel, eval = T, out.width='1\\linewidth', echo=FALSE, fig.cap="(ref:bloodmodel-cap)", fig.scap = "Peripheral ILD classification models", out.extra='', fig.align='center'}
...
kableExtra::kbl(
  ...
  caption.short = "Sex-specific ILD classification model performance") %>%
  kableExtra::kable_styling(full_width = TRUE) %>%  # table spans across left to right margins
  #kableExtra::kable_styling(latex_options = "scale_down") #%>% 
  kableExtra::kable_styling(latex_options = c("hold_position")) # ensures the table isn't "floated" and pins it to the current location
```
...
kableExtra::kbl(
  ...
  caption.short = "IPF vs Control (lung) model weights") %>%
...
kableExtra::kbl(
  ...
  caption.short = "IPF vs Control (blood) model weights") %>%
  kableExtra::kable_styling(full_width = FALSE) %>%  # table spans across left to right margins
  #kableExtra::kable_styling(latex_options = "scale_down") #%>% 
  kableExtra::kable_styling(latex_options = c("HOLD_position", "repeat_header"), font_size = 8) # ensures the table isn't "floated" and pins it to the current location
```
...
kableExtra::kbl(
  ...
  caption.short = "IPF vs Control (PBMC) model weights") %>%
  kableExtra::kable_styling(full_width = FALSE) %>%  # table spans across left to right margins
  #kableExtra::kable_styling(latex_options = "scale_down") #%>% 
  kableExtra::kable_styling(latex_options = c("HOLD_position", "repeat_header"), font_size = 8) # ensures the table isn't "floated" and pins it to the current location
```

(ref:hpgenes-cap) \textbf{Gene weights for HP vs Control (lung) classification model.}
...
kableExtra::kbl(
  ...
  caption.short = "HP vs Control (lung) model weights") %>%
  kableExtra::kable_styling(full_width = FALSE) %>%  # table spans across left to right margins
  #kableExtra::kable_styling(latex_options = "scale_down") #%>% 
  kableExtra::kable_styling(latex_options = c("HOLD_position", "repeat_header"), font_size = 8) # ensures the table isn't "floated" and pins it to the current location
```

(ref:sscgenes-cap) \textbf{Gene weights for SSc-ILD vs Control (lung) classification model.}
...
kableExtra::kbl(
  ...
  caption.short = "SSc-ILD vs Control (lung) model weights") %>%
  kableExtra::kable_styling(full_width = FALSE) %>%  # table spans across left to right margins
  #kableExtra::kable_styling(latex_options = "scale_down") #%>% 
  kableExtra::kable_styling(latex_options = c("HOLD_position", "repeat_header"), font_size = 8) # ensures the table isn't "floated" and pins it to the current location
```
...
kableExtra::kbl(
  ...
  caption.short = "NSIP vs Control (lung) model weights") %>%
  kableExtra::kable_styling(full_width = FALSE) %>%  # table spans across left to right margins
  #kableExtra::kable_styling(latex_options = "scale_down") #%>% 
  kableExtra::kable_styling(latex_options = c("HOLD_position", "repeat_header"), font_size = 8) # ensures the table isn't "floated" and pins it to the current location
```
...
kableExtra::kbl(
  ...
  caption.short = "IPF vs non-IPF (lung) model weights") %>%
  kableExtra::kable_styling(full_width = FALSE) %>%  # table spans across left to right margins
  #kableExtra::kable_styling(latex_options = "scale_down") #%>% 
  kableExtra::kable_styling(latex_options = c("HOLD_position", "repeat_header"), font_size = 8) # ensures the table isn't "floated" and pins it to the current location
```
...
kableExtra::kbl(
  ...
  caption.short = "HP vs non-HP (lung) model weights") %>%
  kableExtra::kable_styling(full_width = FALSE) %>%  # table spans across left to right margins
  #kableExtra::kable_styling(latex_options = "scale_down") #%>% 
  kableExtra::kable_styling(latex_options = c("HOLD_position", "repeat_header"), font_size = 8) # ensures the table isn't "floated" and pins it to the current location
```
...
kableExtra::kbl(
  ...
  caption.short = "IPF vs HP (lung) model weights") %>%
  kableExtra::kable_styling(full_width = FALSE) %>%  # table spans across left to right margins
  #kableExtra::kable_styling(latex_options = "scale_down") #%>% 
  kableExtra::kable_styling(latex_options = c("HOLD_position", "repeat_header"), font_size = 8) # ensures the table isn't "floated" and pins it to the current location
```
...
kableExtra::kbl(
  ...
  caption.short = "IPF vs NSIP (lung) model weights") %>%
  kableExtra::kable_styling(full_width = FALSE) %>%  # table spans across left to right margins
  #kableExtra::kable_styling(latex_options = "scale_down") #%>% 
  kableExtra::kable_styling(latex_options = c("HOLD_position", "repeat_header"), font_size = 8) # ensures the table isn't "floated" and pins it to the current location
```
...
kableExtra::kbl(
  ...
  caption.short = "HP vs NSIP (lung) model weights") %>%
  kableExtra::kable_styling(full_width = FALSE) %>%  # table spans across left to right margins
  #kableExtra::kable_styling(latex_options = "scale_down") #%>% 
  kableExtra::kable_styling(latex_options = c("HOLD_position", "repeat_header"), font_size = 8) # ensures the table isn't "floated" and pins it to the current location
```
...
```{r nsipmodel, eval = T, out.width='0.9\\linewidth', echo=FALSE, fig.cap="(ref:nsipmodel-cap)", fig.scap = "NSIP-specific classification model", out.extra='', fig.align='center'}
...
```{r ildvsildspecific, eval = T, out.width='0.8\\linewidth', echo=FALSE, fig.cap="(ref:ildvsildspecific-cap)", fig.scap = "ILD subtype vs. subtype classification models", out.extra='', fig.align='center'}
...
```{r bayes, eval = T, out.width='0.8\\linewidth', echo=FALSE, fig.cap="(ref:bayes-cap)", fig.scap = "Bayesian changepoint analysis", out.extra='', fig.align='center'}
...
kableExtra::kbl(
  ...
  caption.short = "Up-regulated ILD lung pathways") %>%
...
kableExtra::kbl(
  ...
  caption.short = "Down-regulated ILD lung pathways") %>%
  column_spec(column=1, width="1.0in") %>%
  column_spec(column=2, width="4.5in") %>%
  #column_spec(column=3, width="1in") %>%
  kableExtra::kable_styling(full_width = F) %>%  # table spans across left to right margins
...
kableExtra::kbl(
  ...
  caption.short = "Up- and down-regulated IPF blood and PBMC pathways") %>%
  column_spec(column=1, width="1.0in") %>%
  column_spec(column=2, width="4.5in") %>%
  kableExtra::kable_styling(full_width = F) %>%  # table spans across left to right margins
  #kableExtra::kable_styling(latex_options = "scale_down") #%>% 
...
kableExtra::kbl(
  ...
  caption.short = "Up-regulated IPF vs non-IPF pathways") %>%
  column_spec(column=1, width="1.0in") %>%
  column_spec(column=2, width="4.5in") %>%
  kableExtra::kable_styling(full_width = F) %>%  # table spans across left to right margins
  #kableExtra::kable_styling(latex_options = "scale_down") #%>% 
...
kableExtra::kbl(
  ...
  caption.short = "Up-regulated HP vs non-HP pathways") %>%
  column_spec(column=1, width="1.0in") %>%
  column_spec(column=2, width="4.5in") %>%
  #column_spec(column=3, width="1in") %>%
  kableExtra::kable_styling(full_width = F) %>%  # table spans across left to right margins
...
kableExtra::kbl(
  ...
  caption.short = "Up-regulated ILD cell annotations"
  ) %>%
...
kableExtra::kbl(
  ...
  caption.short = "Down-regulated ILD cell annotations") %>%
  column_spec(column=1, width="0.8in") %>%
  column_spec(column=2, width="4.5in") %>%
  #column_spec(column=3, width="1in") %>%
  kableExtra::kable_styling(full_width = F) %>%  # table spans across left to right margins
...
```{r biclusterall, eval = T, out.width='0.8\\linewidth', echo=FALSE, fig.cap="(ref:biclusterall-cap)", fig.scap = "Biclusters", out.extra='', fig.align='center'}
...
```{r biclusterjaccard, eval = T, out.width='1\\linewidth', echo=FALSE, fig.cap="(ref:biclusterjaccard-cap)", fig.scap = "Bicluster similarity matrix", out.extra=''}
...
kable(#biclusters[c(1,2,11,3,12,4,8,5,6,9,7,10,13,14,15,16),],
  ...
  caption.short = "ILD bicluster genes") %>% 
...
kableExtra::kbl(
  ...
  caption.short = "Bicluster pathway analysis"
  ) %>%
...
(ref:biclusterIPF-cap) \textbf{Association of bicluster IPF sample membership with predicted FVC\%, D\textsubscript{LCO}\%, and age.} Columns ‘Non-Cluster’ and ‘Bicluster’ indicate number of samples in each comparison.
...
kable(
  ...
  caption.short = "IPF bicluster association with demographic variables"
  ) %>% 
...
(ref:biclusterILD-cap) \textbf{Association of bicluster ILD sample membership with predicted FVC\%, D\textsubscript{LCO}\%, and age.} Columns ‘Non-Cluster’ and ‘Bicluster’ indicate number of samples in each comparison.
...
kable(
  ...
  caption.short = "ILD bicluster association with demographic variables"
  ) %>% 
  column_spec(column=1, width="1.5in") %>%
  column_spec(column=2, width="0.7in") %>%
  column_spec(column=3, width="0.5in") %>%
...
```{r envisia, eval = T, out.width='0.6\\linewidth', echo=FALSE, fig.cap="(ref:envisia-cap)", fig.scap = "Comparison with Envisia classifier", out.extra='', fig.align="center"}
