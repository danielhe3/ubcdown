...
knitr::include_graphics("./Figures/FigE3_upset.pdf")
```
...
knitr::include_graphics("./Figures/FigE4_blood.pdf")
```
...
knitr::include_graphics("./Figures/FigE7_bayes.pdf")
```
...
knitr::include_graphics("./Figures/FigE8_allbiclusters.png")
```
...
knitr::include_graphics("./Figures/FigE9_biclusterjaccard.pdf")
```
...
```{r envisia, eval = T, out.width='1\\linewidth', echo=FALSE, fig.cap="(ref:envisia-cap)", fig.scap = "Envisia comparison", out.extra=''}
knitr::include_graphics("./Figures/FigE10_Envisia.pdf")
```
