...
kable(
  ...
  column_spec(column=1, width="1.9in") %>%
...
```{r clusterdiff, eval = T, echo = F, warning = FALSE, message=FALSE,  out.extra=''}
...
```{r bulkscrnaseq, eval = T, out.width='0.8\\linewidth', echo=FALSE, fig.cap="(ref:bulkscrnaseq-cap)", fig.scap = "scRNAseq DEG expression in bulk RNA-seq", out.extra=''}
