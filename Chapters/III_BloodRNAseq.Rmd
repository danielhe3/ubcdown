...
### The SSc-ILD peripheral transcriptome is distinct from other ILD subtypes
...
```{r degild, eval = T, out.width='0.9\\linewidth',echo=FALSE, fig.cap="(ref:degild-cap)", fig.scap = "SSc-ILD transcriptome", out.extra='', fig.align='center'}
